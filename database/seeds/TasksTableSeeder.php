...
class TasksTableSeeder extends Seeder {
	...
	public function run()
	{
	  //uncomment line below to wipe table clean before populating.
	  ...
	  ['id' => 1, 'name' => 'Task 1', 'slug'=> 'task-1','project_id' => 1, 'completed' => false, 'description' =>'My first task','created_at' => new Datetime, 'updated_at' => new Datetime],
            ...
            ['id' => 5, 'name' => 'Task 5', 'slug' => 'task-5', 'project_id' => 3, 'completed' => true, 'description' => 'My third task', 'created_at' => new DateTime, 'updated_at' => new DateTime],
		...
		//uncomment line to run the seeder.
